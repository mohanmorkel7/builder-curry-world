  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside
          className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 shadow-lg lg:shadow-none transition-transform duration-300 ease-in-out`}
        >
